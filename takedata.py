...
for line in reversed(data):
    ...
    indexs['bourcind'] = Index('شاخص کل بورس', line[6], line[9], datetime.strptime(line[8],'%Y-%m-%d').date())
    indexs['btc'] = Index('بیت کوین', line[7], line[9], datetime.strptime(line[8],'%Y-%m-%d').date())
